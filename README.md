...
> AI-powered multi-tenant fleet management platform for trucking companies. Features an agentic dispatcher powered by Claude that autonomously optimizes load-to-truck assignments, ensures HOS compliance, and searches load boards — with real-time GPS tracking, invoicing, and payroll built on a modern cloud-native architecture.
