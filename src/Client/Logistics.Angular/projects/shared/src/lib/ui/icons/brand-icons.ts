/**
 * Hand-vendored brand glyphs. **Lucide ships no brand icons**, so these are entries in
 * `UI_ICONS` (see `./icons`) under the keys `brand-facebook` / `brand-github` / `brand-linkedin` / `brand-x`.
 *
...
/** simple-icons: GitHub */
export const brandGithub = brandSvg(
