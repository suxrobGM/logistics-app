...
export function SceneInvoicing(): ReactElement {
  return (
    <AbsoluteFill className="bg-base">
      <ScreenshotFrame
        src="screenshots/tms-invoices.png"
        delay={5}
        startScale={1.05}
        endScale={1.0}
        panX={-8}
      ...
      <AbsoluteFill className="justify-end bg-linear-to-t from-black/50 to-transparent px-15 pb-12">
        <Sequence from={20} layout="none">
          <AnimatedText
            text="Invoicing & Payments, Simplified."
            delay={20}
            fontSize={36}
            fontWeight={700}
            color="#ffffff"
        ...
        <Sequence from={40} layout="none">
          <AnimatedText
            text="Track every invoice from draft to paid"
            delay={40}
            fontSize={20}
            fontWeight={400}
