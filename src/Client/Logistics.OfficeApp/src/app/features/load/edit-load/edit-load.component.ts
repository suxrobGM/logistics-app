...
export class EditLoadComponent implements OnInit {
  ...
  private createLoad() {
    ...
    const command: CreateLoad = {
      ...
      originLongitude: this.form.value.orgCoords[0],
      originLatitude: this.form.value.orgCoords[1],
      destinationAddress: this.form.value.dstAddress,
      destinationLongitude: this.form.value.dstCoords[0],
      destinationLatitude: this.form.value.dstCoords[1],
