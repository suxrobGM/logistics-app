...
import { LOADS_CHART_PALETTE, LOADS_PERFORMANCE_CHART_OPTIONS, LOADS_PIE_OPTIONS, LOADS_TREND_CHART_OPTIONS, LOADS_TYPE_CHART_OPTIONS } from '@/shared/constants/loads-chart.options';
