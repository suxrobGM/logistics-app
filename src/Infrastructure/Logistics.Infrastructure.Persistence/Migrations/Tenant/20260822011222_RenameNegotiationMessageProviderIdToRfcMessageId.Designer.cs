...
namespace Logistics.Infrastructure.Persistence.Migrations.Tenant
{
    ...
    [Migration("20260822011222_RenameNegotiationMessageProviderIdToRfcMessageId")]
    partial class RenameNegotiationMessageProviderIdToRfcMessageId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.AccountingProviderConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DefaultPaymentAccountId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("default_payment_account_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_accounting_provider_configurations");

                    b.HasIndex("ProviderType")
                        .IsUnique()
                        .HasDatabaseName("ix_accounting_provider_configurations_provider_type");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.AgentDecision", b =>
                {
                    ...
                    b.HasIndex("SessionId")
                        .HasDatabaseName("ix_agent_decisions_session_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_agent_decisions_status");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.AgentSession", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("StartedAt"), new[] { "EstimatedCostUsd" });
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.BrokerCreditRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool?>("AuthorityActive")
                        .HasColumnType("boolean")
                        .HasColumnName("authority_active");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_broker_credit_records");

                    b.HasIndex("McNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_broker_credit_records_mc_number");

                    b.ToTable("broker_credit_records", (string)null);
                });
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.LoadBoardListing", b =>
                {
                    ...
                    b.Property<DateTime?>("BrokerCreditCheckedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("broker_credit_checked_at");

                    b.Property<int?>("BrokerCreditScore")
                        .HasColumnType("integer")
                        .HasColumnName("broker_credit_score");

                    b.Property<int?>("BrokerDaysToPay")
                        .HasColumnType("integer")
                        .HasColumnName("broker_days_to_pay");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.QboEntityMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("LastSyncedHash")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<string>("QboId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("qbo_id");

                    b.Property<string>("QboSyncToken")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("qbo_sync_token");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_qbo_entity_mappings");

                    b.HasIndex("SyncStatus")
                        .HasDatabaseName("ix_qbo_entity_mappings_sync_status");

                    b.HasIndex("LocalEntityType", "LocalId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.AgentDecision", b =>
                {
                    b.HasOne("Logistics.Domain.Entities.AgentSession", "Session")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_agent_decisions_agent_session_session_id");
