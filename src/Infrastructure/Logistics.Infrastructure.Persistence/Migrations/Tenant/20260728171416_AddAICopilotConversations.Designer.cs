...
namespace Logistics.Infrastructure.Persistence.Migrations.Tenant
{
    ...
    [Migration("20260728171416_AddAICopilotConversations")]
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.AgentSession", b =>
                {
                    ...
                    b.HasIndex("ConversationId")
                        .HasDatabaseName("ix_ai_dispatch_sessions_conversation_id");
            ...
            modelBuilder.Entity("Logistics.Domain.Entities.AgentSession", b =>
                {
                    b.HasOne("Logistics.Domain.Entities.AICopilotConversation", "Conversation")
                        ...
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_ai_dispatch_sessions_ai_copilot_conversations_conversation_");
