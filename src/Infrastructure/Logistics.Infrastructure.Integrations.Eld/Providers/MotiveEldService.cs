    ...
    : IEldProviderService
{
    ...
    private string? keepTruckingApiKey;

    public EldProviderType ProviderType => EldProviderType.Motive;

    public void Initialize(EldProviderConfiguration configuration)
    {
        keepTruckingApiKey = configuration.ApiKey;
        httpClient.DefaultRequestHeaders.Add("X-Api-Key", keepTruckingApiKey);
    }
    ...
    private static EldDriverHosDataDto MapToDto(MotiveHosData data)
    {
    ...
    private static EldViolationDataDto MapToViolationDto(string driverId, MotiveViolationData data)
    {
    ...
    private static EldDriverDto MapToDriverDto(MotiveUserData data)
    {
    ...
    private static EldVehicleDto MapToVehicleDto(MotiveVehicleData data)
    {
