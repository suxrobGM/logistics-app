    ...
    public async Task<IEnumerable<LoadBoardListingDto>> SearchLoadsAsync(LoadBoardSearchCriteria criteria)
    {
        ...
        try
        {
            ...
            var searchRequest = new
            {
                origin = new
                {
                    city = criteria.OriginAddress?.City, stateProvince = criteria.OriginAddress?.State,
                    deadheadMiles = criteria.OriginRadius
                },
                destination = criteria.DestinationAddress != null
                    ? new
                    {
                        city = criteria.DestinationAddress.City, stateProvince = criteria.DestinationAddress.State,
        ...
        try
        {
            ...
            var postRequest = new
            {
                ...
                destination = request.DestinationPreference != null
                    ? new
                    {
                        city = request.DestinationPreference.City, stateProvince = request.DestinationPreference.State,
