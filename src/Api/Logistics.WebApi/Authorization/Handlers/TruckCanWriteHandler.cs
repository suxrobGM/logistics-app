...
public class TruckCanWriteHandler : AuthorizationHandler<TruckCanWriteRequirement>
{
    protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, TruckCanWriteRequirement requirement)
    {
