...
- Speech: on-device STT/TTS in the KMP app (`private/src/Client/Logistics.DriverApp/`) - platform APIs first (Android SpeechRecognizer / iOS Speech), streaming ASR later.
