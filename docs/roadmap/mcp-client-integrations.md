...
- MCP client in `Infrastructure.AI`: discover remote tools, merge into the session's tool list alongside `AgentToolRegistry` (namespaced, e.g. `ext_fuelcard_get_balance`).
