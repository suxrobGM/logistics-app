...
import {
  ...
  Stack, // ui-stack, ui-grid, ui-container, ui-surface, ui-page-header
...
| Area       | Components                                                                                                                                                                                                                                                                                                                                       |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Forms      | `ui-form-field`, `ui-text-field`, `ui-textarea-field`, `ui-select-field`, `ui-multiselect-field`, `ui-number-field`, `ui-currency-field`, `ui-unit-field`, `ui-date-field`, `ui-date-range-picker`, `ui-checkbox-field`, `ui-toggle-field`, `ui-password-field`, `ui-autocomplete-field`, `ui-search-field`, `ui-phone-field`, `ui-address-form` |
...
| Display    | `ui-typography`, `ui-avatar`, `ui-timeline`, `ui-chart`, `ui-pdf-viewer`, `ui-alert`                                                                                                                                                                                                                                                             |
...
| Layout     | `ui-divider`, `ui-container`, `ui-grid`, `ui-stack`, `ui-surface`                                                                                                                                                                                                                                                                                |
...
`@logistics/shared/services` - never inject `MessageService` or `ConfirmationService`.
