...
public class LlmPricingTests
{
    ...
    [InlineData("claude-opus-4-8", 1_000_000, 0, 0, 0, 5.0)]
    [InlineData("claude-opus-4-8", 0, 1_000_000, 0, 0, 25.0)]
